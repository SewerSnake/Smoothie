...
namespace MedicineTracker.Pages
{
    public partial class MedicineListPage : ContentPage
    {
        ...
        {
            //App.SelectedItem = new Database.Database().GetItem((e.SelectedItem as SmoothieListItem).Id);
            App.SelectedSmoothie = new Database.Database().GetItem((e.SelectedItem as SmoothieListItem).Id);
            await _viewModel.Navigation.NavigateTo<EditMedicineItemPageViewModel>();
        }
        ...
        protected override async void OnAppearing()
        {
            ...
            MedicineListView.BindingContext = _viewModel.SmoothieList;
